...
def monitor_loop():
    while True:
        ...
        try:
            ...
            draw.text((0, 24), f"RAM: {ram_used_mb}/{ram_total_mb}MB ({ram.percent})", font=font, fill=255)
            draw.text((0, 36), f"Disk: {disk_used_gb}/{disk_total_gb}GB ({disk.percent})", font=font, fill=255)
